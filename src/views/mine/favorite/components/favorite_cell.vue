    ...
    <div style="display:flex;flex-direction: row;text-align: center;margin-top: 10px;background-color: #ffffff;width: 100vw;height: 105px;">
        ...
        <div style="display:inline-block;flex: 1;">
            ...
            <div style="display:flex;flex-direction: row;">
                <div style="flex:2;text-align:left;color: #f03838;margin-left: 10px;width: 70%;margin-top: 10px;">会员价:¥{{item.pn}}</div>
                <img style="height:40px;border-radius:50%;margin-top: 10px;margin-right: 10px;" src="data:image/png;base64,">
