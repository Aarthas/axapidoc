<template>
    <div style="display: flex;flex-direction: row;height: 110px;margin-bottom: 1px;background-color: white;">
        ...
        <div  style="width: 30px;" v-on:click="single">
            ...
            <y-icon style="line-height: 100px;" v-model="checked"></y-icon>
        </div>
        ...
        <div style="display: flex;flex-direction: column;flex: 1;">
            ...
            <div style="display: flex;flex-direction: row;flex: 1;">
                ...
                <add_sub v-show="typedId !=-1" v-model="cellItem.number" style="margin-right: 8px;flex: 1;"  @on-add="on_add" @on-sub="on_sub"></add_sub>
            </div>
        </div>
    </div>
</template>
