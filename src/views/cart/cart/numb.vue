    ...
    <div class="weui-cell">
        ...
        <div style="display:flex;flex-direction: row;text-align: center;margin-top: 10px;background-color: #ffffff;width: 100vw;height: 105px;">
            <div  style="display:inline-block;margin-left: 8px;">
                <img src="http://www.oschina.net/build/oschina/community/stylesheets/imgs/zb/zb_wordpress.jpg?t=1484694830000"  class="ximg-demo" error-class="ximg-error" :offset="-100" container="#vux_view_box_body" ></img>
            </div>
