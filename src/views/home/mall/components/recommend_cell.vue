<template>
    ...
    <div style=" display: flex;flex-direction: column;background-color: #ffffff;height: 230px;margin :2px 5px 5px 5px;">
        ...
        <div style="display: flex;flex-direction: row;margin: 0px 8px 8px 8px;">
           <div style="color: #f03838;font-size: 15px;text-align: left;flex: 1;margin-top: 10px;" >￥{{item.pn}}</div>
           <img style="margin-bottom: 0;margin-right: 0;width: 40px;height: 40px;border-radius:50%;" src="data:image/png;base64,">
        </div>
    </div>
